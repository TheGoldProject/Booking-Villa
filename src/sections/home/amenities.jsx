  ...
  return (
    <section id="gallery" className="mt-20">
      <div class="py-6 sm:py-8 lg:py-12">
        <div class="flex flex-col items-center mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div class="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-3">
            {premiumAmenities.map((amenity, i) => (
              <div key={i} class="flex divide-x rounded-lg border bg-gray-50">
                <div class="flex items-center p-2 text-cyan-500 md:p-4">
                  {amenity.icon}
                </div>
